                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <?php 
                                                ...
                                                $query = "SELECT COUNT(*) as total FROM seminar WHERE hod_approval = ?";
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                    // Prepare the query with placeholders
                                                    $query = "SELECT COUNT(*) as total FROM seminar WHERE hod_approval = ? AND admin_approval = ?";
                                                    $stmt = $con->prepare($query);
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                            ...
                                            <?php 
                                                // Prepare the query with placeholders
                                                $query = "SELECT COUNT(*) as total FROM seminar WHERE admin_approval = ?";
                                                $stmt = $con->prepare($query);
