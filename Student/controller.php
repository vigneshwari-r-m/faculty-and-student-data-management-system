...
if(isset($_POST['std-signup'])){
    ...
    if(count($errors) === 0){
        ...
        $insert_data = "INSERT INTO student (student_id, student_name, degree, course, email, contact, batch, dob, password, code, status)
                        values('$student_id','$student_name','$degree','$course','$email', '$contact','$batch','$dob', '$encpass', '$code', '$status')";
