            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Faculty Exchange - Form</h1>                       
                    </div>
                        ...
                        <div class="col-xl-auto">
                            ...
                            <div class="card shadow mb-2">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Details of Faculty Exchange
                                        <a href="faculty-exchange-form.php" onclick="hideForm()" style="margin-left:650px; align-items: flex-end;" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" >
                                        <i class="fi fi-rr-cross-small text-white-500"></i></a> </h6>
                                </div>
                                <div class="card-body">
                                    <div class="text-center">
                                    <?php include('message.php'); ?>
                                     <form method="POST" action="faculty-exchange-add-new.php" enctype='multipart/form-data'>
                                     <div class="form-row">
                                     ...
                                     <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6 text-left">
                                                <label for="title">Title of the Collaborative Activity</label>
                                                <input type="text" name="activity_name" class="form-control" id="title" required placeholder="Enter the Title of the Collaborative Activity">
                                                </div>
                                                <div class="form-group col-md-6 text-left">
                                                    <label for="type">Type of Collaborative Activity</label>
                                                    <select class="form-control" name="type" id="type" >
                                                        <option selected>Choose a Collaborative Activity</option>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6 text-left">
                                                <label for="participants">Collaborating Agency Name</label>
                                                <input type="text" name="agency" class="form-control" placeholder="Enter the Collaborating Agency Name" id="participants">
                                                </div>
                                                <div class="form-group col-md-6 text-left">
                                                    <label for="coordinator">Collaborating Agency Contact Details</label>
                                                    <input type="text" name="contact" class="form-control" placeholder="Enter Collaborating Agency Contact Details" id="coordinator_name">
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md-6 text-left">
                                                <label for="participants">Details of MoU Collaboration</label>
                                                <input type="text" name="mou" class="form-control" placeholder="Enter the Details of MoU Collaboration" id="participants">
                                                </div>
                                                <div class="form-group col-md-6 text-left">
                                                    <label for="coordinator">Name of the Participant</label>
                                                    <input type="text" name="participant_name" class="form-control" placeholder="Enter the Participant Name" id="coordinator_name">
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md-6 text-left">
                                                 ...
                                                 <div class="container">
                                                    <div class="row justify-content-center">
                                                        ...
                                                        <div class="form-group">
                                                            <button type="submit" name="exchange-submit" class="btn btn-primary btn-block">Submit</button>
                                                        </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="form-group text-left col-md-12">
                                                            <div class="card p-3" style="background-color:#f1f1f1;">
                                                                <h5 class="font-weight-bold mb-3 text-center">Documents to be Uploaded as per the following details</h5>
                                                                    <ul>
                                                                        <li><span style="font-size: 16px; ">List of teachers and students who have received the awards along with nature of exchange, the awarding agency etc.</span></li>
                                                                        <li><span style="font-size: 16px; ">List of activities and exchange should be provided </span></li>
