            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="conference-add-new.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                               ...
                               <button class="btn btn-primary" type="button">
                                ...
                                <thead>
                                                <tr style="background-color:#f8f9fc; text-align:center">
                                                    ...
                                                    <th>Level of Conference</th>
                                                    <th>Venue</th>
                                                    <th>Organized By</th>
                                                    <th>Title of the Conference Preceedings</th>
                                                    <th>Page No. in Preceedings</th>
                                                    <th>ISBN of the Conference Preceeding</th>
                                    ...
                                    $query = "SELECT id, conference_title, paper_title, position,start_date,end_date,days, type, level,venue,organizer,preceeding_title,pages,isbn,year,institute,publisher_name,financial_support, proof, hod_approval, hod_remarks, admin_approval, admin_remarks 
                                    FROM conference
                                    ...
                                    <tr>
                                        <td><?= $serial_no++; ?></td>
                                        <td><?= htmlspecialchars($row['conference_title']); ?></td>
                                        ...
                                        <td><?= htmlspecialchars($row['preceeding_title']); ?></td>
