...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">FDP / STTP / PDP Forms to be approved</h1>
    ...
    <div class="card shadow mb-4">
        ...
        $query = "SELECT id,userid,name,title,days,program_type,start_date,end_date,venue,financial_support,proof,hod_approval,hod_remarks FROM fdp WHERE hod_approval='Pending Approval' and department=?";
