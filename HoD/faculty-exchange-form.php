            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Faculty Exchange</h1>
                        <a href="faculty-exchange-add-new.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                               ...
                               <button class="btn btn-primary" type="button">
                                ...
                                <thead>
                                                <tr style="background-color:#f8f9fc; text-align:center">
                                                    <th>S.No</th>
                                                    <th>Name of the Collaborative Activity</th>
                                                    <th>Name of the Collaborating Agency</th>
                                                    <th>Collaborating Agency Contact Details</th>
                                                    <th>Type of Collaborative</th>
                                                    <th>Details of MoU Collaboration</th>
                                    ...
                                    $query = "SELECT id, activity_name, agency, contact, type, mou,participant_name,start_date,end_date, days, financial_support, proof, hod_approval, hod_remarks, admin_approval, admin_remarks 
                                    FROM exchange
                                    ...
                                    <tr>
                                        ...
                                        <td><?= htmlspecialchars($row['mou']); ?></td>
