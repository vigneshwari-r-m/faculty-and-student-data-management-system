...
<head>
    ...
    <title><?php echo $fetch_info['name']?> | Event Organized</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Event Organized - Form</h1>                       
                    </div>
                        ...
                        <div class="col-xl-auto">
                            ...
                            <div class="card shadow mb-2">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Details of Event Organized 
                                        <a href="event-form.php" onclick="hideForm()" style="margin-left:650px; align-items: flex-end;" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" >
                                        <i class="fi fi-rr-cross-small text-white-500"></i></a> </h6>
                                </div>
                                <div class="card-body">
                                    <div class="text-center">
                                    <?php include('message.php'); ?>
                                     <form method="POST" action="event-add-new.php" enctype='multipart/form-data'>
                                     <div class="form-row">
                                     ...
                                     <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6 text-left">
                                                <label for="title">Enter the Title of the Programme</label>
                                                ...
                                                <div class="form-group col-md-6 text-left">
                                                    ...
                                                    <select class="form-control" name="program_type" id="type" >
                                                        ...
                                                        <option>Seminars conducten on Intellectual Property Rights(IPR)</option>
                                                        <option>Research Methodology</option>
                                                        <option>Entrepreneurship and Skill Development</option>
                                                        <option>Professional Development</option>
                                                        <option>Administrative Training</option>
                                                        <option>Conference</option>
                                                        <option>Professional Society</option>
                                                        <option>Department Association</option>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <input type="text" name="participants" class="form-control" placeholder="Enter the Participants Count" id="participants">
                                                </div>
                                                <div class="form-group col-md-6 text-left">
                                                    <label for="coordinator">Coordinator Name</label>
                                                    <input type="text" name="coordinator_name" class="form-control" placeholder="Enter Coordinator Name" id="coordinator_name">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-row">
                                                    <div class="form-group col-md-6 text-left">
                                                        ...
                                                        <select class="form-control" id="level" name="level" placeholder="Enter the Level">
                                                    ...
                                                    <div class="form-group col-md-6 text-left">
                                                        <label for="feedback">Program Feedback</label>
                                                        <select class="form-control" id="feedback" name="feedback" placeholder="Enter the Level">
                                                            <option selected>Is the Feedback Collected</option>
                                                            <option>Yes</option>
                                                            <option>No</option>
                                                        </select>
                                                    </div>
                                            ...
                                            <div class="form-row">
                                                ...
                                                function showFun(selectFund){
                                                    var sf=document.getElementById("sf");
                                                    sf.style.display =selectFund.checked ? "block" : "none";
                                                }
                                                function showSponsor(selectSpons){
                                                    var sp=document.getElementById("sp");
                                                    sp.style.display =selectSpons.checked ? "block" : "none";
                                                }
                                                </script>
                                                 ...
                                                 <div class="form-row">
                                                    ...
                                                    <div class="form-check mb-2 mr-sm-2 text-left">
                                                        <input class="form-check-input" type="checkbox" id="selectFund" onclick="showFun(this)">
                                                        <label class="form-check-label" for="selectFund">
                                                        Is any Fund Received?
                                                        </label>
                                                    </div>
                                                    <div id="sf" style="display: none">
                                                        <select type="text" name="fund" id="fund" class="form-control">
                                                    ...
                                                    <div class="form-group col-md-6 text-left">
                                                    <div class="form-check mb-2 mr-sm-2 text-left">
                                                        <input class="form-check-input" type="checkbox" id="selectSpons" onclick="showSponsor(this)">
                                                        <label class="form-check-label" for="selectSpons">
                                                        Is any Companies/Universities Involved ?
                                                        </label>
                                                    </div>
                                                    <div id="sp" style="display: none">
                                                    <input type="text" name="sponsors" id="amount" placeholder="Enter the Name of the Organization and Contact Details" class="form-control" />
                                                 ...
                                                 <div class="container">
                                                    <div class="row justify-content-center">
                                                        ...
                                                        <div class="form-group">
                                                            <button type="submit" name="event-submit" class="btn btn-primary btn-block">Submit</button>
                                                        </div>
                                                        </div>
                                                    </div>
                                                </div>
