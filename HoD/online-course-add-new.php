            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Online Course - Form</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card shadow mb-2">
                                ...
                                <h6 class="m-0 font-weight-bold text-primary">Details of Online Courses Completed
                                   
                                    <a href="pbm-form.php" onclick="hideForm()" style="margin-left:650px;" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" >
                                     ...
                                     <form method="POST" action="pbm-add-new.php" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group col-md-6 text-left">
                                                ...
                                                <div class="form-group col-md-6 text-left">
                                                    ...
                                                    <input type="text" name="course_name" class="form-control" required id="title" placeholder="Enter Course Name" value="<?php echo $title ?>">
                                                </div>
                                            </div>
                                            <div class="form-row">
                                            <div class="form-group col-md-6 text-left">
                                                <label for="month">Course Started Month & Year</label>
                                                <input type="text" id="monthpicker" class="form-control" name="course_month" placeholder="Select the Month & Year of the Course Started">
                                            </div>

                                                <div class="form-group col-md-6 text-left">
                                                    <label for="en_date">Course Duration(In Weeks)</label>
                                                    <input type="text" name="duration" class="form-control" placeholder="Enter the Course Duration(In Weeks)" id="duration">
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md-6 text-left">
                                                    <label for="days">Platform</label>
                                                    <input type="text" name="platform" class="form-control" placeholder="Ex: NPTEL,Coursera,Edx" id="platfform"></input>
                                                  
                                                </div>

                                                <div class="form-group col-md-6 text-left">
                                                    <label for="fee_date">Recognition</label>
                                                    <input type="text" name="recognition" class="form-control" placeholder="Ex: Elite,Gold,Silver or % of Marks" id="fee_date">
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md-6 text-left">
                                                <label for="professional">Approved as FDP
                                                </label>
                                                <select name="fdp_approved" class="form-control" id="fdp_approved">
                                                    <option selected>Only for NPTEL</option>
                                                    <option>Yes</option>
                                                    <option>No</option>
                                                </select>
                                                 ...
                                                 <div class="container">
                                                    <div class="row justify-content-center">
                                                        ...
                                                        <div class="form-group">
                                                            <button type="submit" name="oc-submit" class="btn btn-primary btn-block">Submit</button>
                                                        </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="card p-3" style="background-color:#f1f1f1;">
                                                                <h5 class="font-weight-bold mb-3 ">Documents to be Uploaded as per the following details</h5>
                                                                    <ul>
                                                                        <li><span>Copy of the certificate</span></li>
                                                                        <li><span>Copy of FDP certificate</span></li>
                                                                        <li><span>Copy of financial assistance to teachers receiving financial support.</span></li>
                                                                    </ul>
                                                            </div>
                                                        </div>
                                                    </div>
