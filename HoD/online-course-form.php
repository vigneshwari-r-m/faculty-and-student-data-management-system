        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                  ...
                  $query = "SELECT id, course_name, year, course_date, duration , platform, recognition, fdp_approved, financial_support, proof, hod_approval, hod_remarks, admin_approval, admin_remarks 
                  FROM online_course 
