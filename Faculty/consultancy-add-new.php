            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Consultancy - Form</h1>                       
                    </div>
                        ...
                        <div class="col-xl-auto">
                            ...
                            <div class="card shadow mb-2">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Details of Consultancy 
                                        <a href="consultancy-form.php" onclick="hideForm()" style="margin-left:650px; align-items: flex-end;" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" >
                                        <i class="fi fi-rr-cross-small text-white-500"></i></a> </h6>
                                </div>
                                <div class="card-body">
                                    <div class="text-center">
                                    <?php include('message.php'); ?>
                                     <form method="POST" action="consultancy-add-new.php" enctype='multipart/form-data'>
                                     <div class="form-row">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6 text-left">
                                                <label for="title">Name of the consultancy project</label>
                                                <input type="text" name="consultancy_pro" class="form-control" id="consultancy_pro" required placeholder=" Consultancy Project name ">
                                                </div>
                                                

                                                <div class="form-group col-md-6 text-left">
                                                <label for="title">Consulting /Sponsoring agency with contact details</label>
                                                <input type="text" name="consultancy_name" class="form-control" id="consulatncy_name" required placeholder="Name of the Consulting agency">
                                                </div>
                                            ...
                                            <div class="form-row">
                                            <div class="form-group col-md-6 text-left">
                                                <label for="title">Agency seeking training with contact details</label>
                                                <input type="text" name="agency_name" class="form-control" id="agency_name" required placeholder="Name of the Agency seeking training (If Corporate Training)">
                                                </div>
                                                <div class="form-group col-md-6 text-left">
                                                    <label for="trainees">Number of trainees</label>
                                                    <input type="text" name="trainees" class="form-control" id="trainees">
                                                </div>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6 text-left">
                                                ...
                                                <div class="form-group col-md-6 text-left">
                                                <label for="title">Revenue generated </label>
                                                <input type="text" name="revenue" class="form-control" id="revenue" required placeholder=" (INR in lakhs)">
                                                </div>
                                                 ...
                                                 <div class="container">
                                                    <div class="row justify-content-center">
                                                        ...
                                                        <div class="form-group">
                                                            <button type="submit" name="consultancy-submit" class="btn btn-primary btn-block">Submit</button>
                                                        </div>
                                                        </div>
                                                    </div>
                                                </div>
