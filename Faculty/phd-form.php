            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Ph. D Registration</h1>
                        <a href="phd-add-new.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                            <i class="fas fa-add fa-sm text-white-500"></i> Add New</a>
                    ...
                    <div class="row">
                            ...
                            <div style="display: flex; justify-content: space-between; align-items: center; padding: 20px;">
                             ...
                             <tr style="background-color:#f8f9fc; text-transform:uppercase; text-align:center; font-size:15px;">
                                 ...
                                 <th>Supervisor Departmnet</th>
                                 <th>Year of Registration</th>
                                 <th>Date of Registration</th>
                                 <th>Status</th>
                                 <th>Link to the allotment order</th>
                  ...
                  $query = "SELECT id, year, program_applied, supervisor_name, supervisor_department, reg_year, reg_date, status,link,financial_support, proof, hod_approval, hod_remarks, admin_approval, admin_remarks FROM phd WHERE userid=?";
                ...
                $result = mysqli_stmt_get_result($stmt);
                  ...
                  <tr>
                      <td><?= $serial_no++; ?></td>
                      <td><?= $row['year']; ?></td>
                      <td><?= htmlspecialchars($row['program_applied']); ?></td>
                      <td><?= htmlspecialchars($row['supervisor_name']); ?></td>
                      <td><?= $row['supervisor_department']; ?></td>
                      <td><?= htmlspecialchars($row['reg_year']); ?></td>
