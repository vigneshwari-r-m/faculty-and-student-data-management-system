...
<head>
    ...
    <title><?php echo $fetch_info['name']?> | Resource Person</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Resource Person - Form</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card shadow mb-2">
                                ...
                                <h6 class="m-0 font-weight-bold text-primary">Details of Resource Person
                                   
                                    <a href="resource-person-form.php" onclick="hideForm()" style="margin-left:750px;" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" >
                                    <i class="fi fi-rr-cross-small text-white-500"></i></a> </h6>
                                </div>
                                <div class="card-body">
                                    <div class="text-center">
                                    <?php include('message.php'); ?>
                                     <form method="POST" action="resource-person-add-new.php" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group col-md-6 text-left">
                                                    ...
                                                    <select name="academic_year" class="form-control" id="year" placeholder="Academic Year" required>Select Year</select>
                                                </div>
                                                <div class="form-group col-md-6 text-left">
                                                    <label for="title">Title of Program</label>
                                                    <input type="text" name="title" class="form-control" required id="title" placeholder="Enter the Title of the programme" value="<?php echo $title ?>">
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md-6 text-left">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6 text-left">
                                                    <label for="fee_date">Venue</label>
                                                    <input type="text" name="venue" class="form-control" placeholder="Enter the Venue" id="venue">
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md-6 text-left">
                                                <label for="professional">Topic Delivered</label>
                                                </label>
                                                <input type="text" name="topic" class="form-control" id="topic" placeholder="Enter the topic you delivered" required >
                                                
                                                </div>
                                                <div class="form-group col-md-6 text-left">
                                                    <label for="type">Select Your Role</label>
                                                    <select class="form-control" name="member_role" id="type" >
                                                        <option selected>Choose Member's Role</option>
                                                        <option>Resource Person</option>
                                                        <option>Chair Person</option>
                                                        <option>Expert in Conference</option>
                                                        <option>FDP and Lecture</option>
                                                        <option>Keynote Delivered in Seminar / Workshop</option>
                                                    </select>
                                                </div>
                                               ...
                                               <div class="form-group col-md-6 text-left">
                                                    ...
                                                    <div id="dvP" style="display: none">
                                                        ...
                                                        <input type="text" name="financial_support" id="amount" class="form-control"  placeholder="Enter the Amount"/>
                                                    </div>
                                                    </div>
                                                 ...
                                                 <div class="container">
                                                    <div class="row justify-content-center">
                                                        ...
                                                        <div class="form-group">
                                                            <button type="submit" name="resource-submit" class="btn btn-primary btn-block">Submit</button>
                                                        </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="card p-3" style="background-color:#f1f1f1;">
                                                                <h5 class="font-weight-bold mb-3 ">Documents to be Uploaded as per the following details</h5>
                                                                    <ul>
                                                                        <li><span>Appreciation letter / certificate of appreciation by the organizer</span></li>
