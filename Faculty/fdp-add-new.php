...
<head>
    ...
    <title><?php echo $fetch_info['name']?> | FDP-STTP</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">FDP / STTP / PDP - Form</h1>                       
                    </div>
                        ...
                        <div class="col-xl-auto">
                            ...
                            <div class="card shadow mb-2">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Details of FDP/STTP/PDP Attended (Only 3 days and above) 
                                        <a href="fdp-form.php" onclick="hideForm()" style="margin-left:550px; align-items: flex-end;" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" >
                                        <i class="fi fi-rr-cross-small text-white-500"></i></a> </h6>
                                </div>
                                <div class="card-body">
                                    <div class="text-center">
                                    <?php include('message.php'); ?>
                                     <form method="POST" action="fdp-add-new.php" enctype='multipart/form-data'>
                                     <div class="form-row">
                                                 ...
                                                 <div class="container">
                                                    <div class="row justify-content-center">
                                                        ...
                                                        <div class="form-group">
                                                            <button type="submit" name="fdp-submit" class="btn btn-primary btn-block">Submit</button>
                                                        </div>
                                                        </div>
                                                    </div>
                                                </div>
