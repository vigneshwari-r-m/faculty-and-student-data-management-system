            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="event-add-new.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                               ...
                               <button class="btn btn-primary" type="button">
                                ...
                                <thead>
                                                <tr style="background-color:#f8f9fc; text-align:center">
                                                    ...
                                                    <th>Venue</th>
                                                    <th>Level</th>
                                                    <th>Program Feedback Collected</th>
                                                    <th>Fund Received</th>
                                                    <th>Partnership / Sponsors</th>
                                                    <th>Proof</th>
                                                    <th>HOD Approval</th>
                                                    <th>HOD Remarks</th>
                                                    <th>IQAC Approval</th>
                                    ...
                                    $query = "SELECT id, title, coordinator_name,program_type,participants, start_date, end_date, days,venue,level,feedback ,fund,sponsors, proof, hod_approval, hod_remarks, admin_approval, admin_remarks 
                                    FROM event_organized
                                    ...
                                    <tr>
                                        ...
                                        <td><?= htmlspecialchars($row['sponsors']); ?></td>
