            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Patent</h1>
                        <a href="patent-add-new.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                              ...
                              <input type="text" class="form-control bg-light border-0 small"  placeholder="Search for..." aria-label="Search" aria-describedby="basic-addon2">
                               ...
                               <button class="btn btn-primary" type="button">
                                ...
                                <thead>
                                                ...
                                                <th>S.No</th>
                                                    <th>Position of Innovator</th>
                                                    <th>Innovation title</th>
                                                    <th>Application Number</th>
                                                    <th>Date of Application</th>
                                                    <th>Field / Publisher Granted</th>
                                                    <th>Date of Field / Publisher Granted</th>
                                                    <th>Patenting body</th>
                                    ...
                                    $query = "SELECT id,position,title,app_number,app_date,type,type_date,patent_body,financial_support,proof,hod_approval,hod_remarks,admin_approval,admin_remarks
                                    FROM patent
                                    ...
                                    <tr>
                                        ...
                                        <td><?= htmlspecialchars($row['app_number']); ?></td>
                                        <td><?= htmlspecialchars($row['app_date']); ?></td>
                                        <td><?= htmlspecialchars($row['type']); ?></td>
                                        <td><?= htmlspecialchars($row['type_date']); ?></td>
                                        <td><?= htmlspecialchars($row['patent_body']); ?></td>
