...
<ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" id="sidebar" style="background-color: #6665ee;">
  ...
  <li class="nav-item active">
    <a class="nav-link" href="faculty-dashboard.php"><i class="fi fi-rr-apps-add"></i><span>Class Coordinator</span></a>
  </li>
  <!-- Divider -->
    ...
    <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="scholarship-form.php"><i class="fi fi-rr-edit" style="padding: 5px;"></i>Scholarship</a>
                        <a class="collapse-item" href="iv-form.php"><i class="fi fi-rr-comment" style="padding: 5px;"></i>Industrial Visit</a>
                        <a class="collapse-item" href="student-exchange-form.php"><i class="fi fi-rr-comment" style="padding: 5px;"></i>Student Exchange</a>
                        <a class="collapse-item" href="events-form.php"><i class="fi fi-rr-comment" style="padding: 5px;"></i>Events Organized for Students</a>
                        <a class="collapse-item" href="iv-form.php"><i class="fi fi-rr-comment" style="padding: 5px;"></i>Industrial Visit</a>
                    </div>
                </div>
            </li>
