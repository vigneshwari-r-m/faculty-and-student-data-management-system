            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Journal Publications</h1>
                        <a href="journal-add-new.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                               ...
                               <button class="btn btn-primary" type="button">
                                ...
                                <thead>
                                                ...
                                                <th>S.No</th>
                                                    ...
                                                    <th>Positon of Author</th>
                                                    <th>Department of Author</th>
                                                    <th>Name of Co-Author</th>
                                                    <th>Positon of Co-Author</th>
                                                    <th>Department of Co-Author</th>
                                                    ...
                                                    <th>Impact Factor</th>
                                                    <th>Indexed by</th>
                                                    <th>Journal Ranking  </th>
                                                    <th>Link</th>
                                                    <th>DOI of the paper</th>
                                                    <th>proof</th>
                                                    <th> HOD Approval</th>
                                                    <th>HOD Remarks</th>
                                                    <th>IQAC Approval</th>
                                    ...
                                    $query = "SELECT id,author_name,author_dept,author_position,co_author_name,co_author_dept,co_author_position,paper_title,journal_name,volume,page_no,year_of,month_of,issn,impact,program_type,journal_rank,link,DOI,proof,hod_approval,hod_remarks,admin_approval,admin_remarks
                                    FROM journal 
                                    ...
                                    <tr>
                                        ...
                                        <td><?= htmlspecialchars($row['author_dept']); ?></td>
                                        <td><?= htmlspecialchars($row['author_position']); ?></td>
                                        <td><?= htmlspecialchars($row['co_author_name']); ?></td>
                                        <td><?= htmlspecialchars($row['co_author_dept']); ?></td>
                                        <td><?= htmlspecialchars($row['co_author_position']); ?></td>
                                        <td><?= htmlspecialchars($row['paper_title']); ?></td>
                                      
                                        <td><?= htmlspecialchars($row['journal_name']); ?></td>
                                        <td><?= htmlspecialchars($row['volume']); ?></td>
                                        <td><?= htmlspecialchars($row['page_no']); ?></td>
                                        <td><?= htmlspecialchars($row['year_of']); ?></td>
                                        <td><?= htmlspecialchars($row['month_of']); ?></td>
                                        <td><?= htmlspecialchars($row['issn']); ?></td>
                                        <td><?= htmlspecialchars($row['impact']); ?></td>
                                        <td><?= htmlspecialchars($row['program_type']); ?></td>
                                        <td><?= htmlspecialchars($row['journal_rank']); ?></td>
