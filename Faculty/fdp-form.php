            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">FDP STTP Programme</h1>
                        <a href="fdp-add-new.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                              ...
                              <input type="text" class="form-control bg-light border-0 small"  placeholder="Search for..." aria-label="Search" aria-describedby="basic-addon2">
                               ...
                               <button class="btn btn-primary" type="button">
                                ...
                                <thead>
                                    ...
                                    $query = "SELECT id, title, days, program_type, start_date, end_date, venue, financial_support, proof, hod_approval, hod_remarks, admin_approval, admin_remarks 
                                    FROM fdp 
