...
<h>
    ...
    <title><?php echo $fetch_info['name']?> | Supervisor</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                  ...
                  $query = "SELECT id, title, year, start_date, end_date, days, fee_date, program_name, financial_support, proof, hod_approval, hod_remarks, admin_approval, admin_remarks FROM pbm WHERE userid=?";
