                             ...
                             <form class="style="padding-left:1000px;">
                              ...
                              <input type="text" class="form-control bg-light border-0 small"  placeholder="Search for..." aria-label="Search" aria-describedby="basic-addon2">
                               ...
                               <thead >
                                    ...
                                    $query = "SELECT id,title,year,program_type,start_date,end_date,days,venue,financial_support,proof,hod_approval,hod_remarks,admin_approval,admin_remarks FROM seminar WHERE userid=? ORDER BY id DESC";
