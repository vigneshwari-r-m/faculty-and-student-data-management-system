...
<head>
    ...
    <title><?php echo $fetch_info['name']?> | Ph. D Registration Form</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Ph. D Registration - Form</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card shadow mb-2">
                                ...
                                <h6 class="m-0 font-weight-bold text-primary">Details of Ph.D Registration
                                   
                                    <a href="phd-form.php" onclick="hideForm()" style="margin-left:800px;" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" >
                                    <i class="fi fi-rr-cross-small text-white-500"></i></a> </h6>
                                </div>
                                <div class="card-body">
                                    <div class="text-center">
                                    <?php include('message.php'); ?>
                                     <form method="POST" action="phd-add-new.php" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group col-md-6 text-left">
                                                ...
                                                <div class="form-group col-md-6 text-left">
                                                    <label for="type">Program Applied</label>
                                                    <select class="form-control" name="program_applied" id="type" >
                                                        <option selected>Choose a Program</option>
                                                        <option>Ph. D</option>
                                                        <option>D. Sc</option>
                                                        <option>D. Litt</option>
                                                        <option>LLD</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md-6 text-left">
                                                    <label for="en_date">Supervisor Name</label>
                                                    <input type="text" name="supervisor_name" class="form-control" placeholder="Enter Supervisor Name" required>
                                                </div>
                                                <div class="form-group col-md-6 text-left">
                                                    <label for="en_date">Supervisor Department</label>
                                                    <input type="text" name="supervisor_department" class="form-control" placeholder="Enter Supervisor Department" required>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md-6 text-left">
                                                    <label for="days">Year of Registration</label>
                                                    <input type="text" name="reg_year" class="form-control" placeholder="Enter the Year of Registration">
                                                    
                                                </div>
                                                <div class="form-group col-md-6 text-left">
                                                    <label for="fee_date">Date of Registration</label>
                                                    <input type="date" name="reg_date" class="form-control" placeholder="Enter the Date of Registration" id="fee_date">
                                                </div>
                                            </div>
                                            <div class="form-row">
                                            <div class="form-group col-md-6 text-left">
                                                <label for="professional">Status
                                                </label>
                                                <input type="text" name="link" class="form-control" id="program_name" placeholder="Enter the Status" required >
                                                
                                                </div>
                                                <div class="form-group col-md-6 text-left">
                                                <label for="professional">Link to the allotment order
                                                </label>
                                                <input type="text" name="link" class="form-control" id="program_name" placeholder="Enter the Allotment Order Link" required >
                                                 ...
                                                 <div class="container">
                                                    <div class="row justify-content-center">
                                                        ...
                                                        <div class="form-group">
                                                            <button type="submit" name="phd-submit" class="btn btn-primary btn-block">Submit</button>
                                                        </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="card p-3" style="background-color:#f1f1f1;">
                                                                <h5 class="font-weight-bold mb-3 ">Documents to be Uploaded as per the following details</h5>
                                                                    <ul>
                                                                        <li><span>Ph.D. registration letters/Joining reports of candidates. </span></li>
                                                                        <li><span>Letter from the university indicating name of the Ph.D. student with title of the doctoral study and the name of the guide. </span></li>
                                                                    </ul>
                                                            </div>
                                                        </div>
                                                    </div>
